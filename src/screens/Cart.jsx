    ...
    <>
      ...
      <aside className="drawer">
        <div style={{ padding: '20px 24px', borderBottom: '1px solid var(--line-1)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div>
            <div className="t-overline" style={{ color: 'var(--text-3)' }}>Pedido em aberto</div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            {cart.length > 0 && (
              <button onClick={clearCart} className="btn btn-ghost btn-sm" title="Limpar carrinho" style={{ color: 'var(--red-30)' }}>
        ...
        {cart.length === 0 ? (
          <div style={{ flex: 1, display: 'grid', placeItems: 'center', padding: 32 }}>
            <div style={{ textAlign: 'center', maxWidth: 280 }}>
              ...
              <div style={{ fontSize: 16, fontWeight: 600 }}>Nenhum produto adicionado</div>
            ...
            <div style={{ padding: '18px 24px', borderTop: '1px solid var(--line-1)', background: 'var(--bg-surface-2)' }}>
              ...
              {monthly > 0 && (
                <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 13, color: 'var(--text-2)', marginTop: 4 }}>
                  <span>Recorrência mensal</span><span style={{ fontFamily: 'var(--font-mono)' }}>{fmtBRL(monthly)}/mês</span>
                </div>
              )}
              <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 13, color: 'var(--text-2)', marginTop: 4 }}>
          ...
          <div style={{ minHeight: 320 }}>
            ...
            {step === 3 && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                <div style={{ fontSize: 13, color: 'var(--text-2)', marginBottom: 4 }}>Forma de pagamento</div>
                {[
